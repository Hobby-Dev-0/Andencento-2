...
@Andencento.on(admin_cmd(pattern="offline$", outgoing=True))
async def _(event):
    if event.fwd_from:
        return
    user_it = "me"
...
@Andencento.on(admin_cmd(pattern="online$", outgoing=True))
async def _(event):
    if event.fwd_from:
        return
    user_it = "me"
...
@Andencento.on(admin_cmd(pattern="pbio (.*)"))
async def _(event):
    if event.fwd_from:
        return
...
@Andencento.on(admin_cmd(pattern="ppic"))
async def _(event):
    if event.fwd_from:
        return
