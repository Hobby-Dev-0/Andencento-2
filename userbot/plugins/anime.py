...
async def nope(hel_):
    ...
    troll = await bot.inline_query("AniFluidbot", f".anime {(deEmojify(user))}")
...
async def nope(hel_):
    ...
    troll = await bot.inline_query("AniFluidbot", f".manga {(deEmojify(user))}")
...
async def nope(hel_):
    ...
    troll = await bot.inline_query("AniFluidbot", f".character {(deEmojify(user))}")
