...
async def carbon_api(e):
    ...
    user = await edit_or_reply(e, "`Carbonizing...\n25%`")
    ...
    await user.edit("`Processing..\n75%`")
    # Waiting for downloading
    await asyncio.sleep(2)
    await user.edit("`Done Dana Done...\n100%`")
    file = "./carbon.png"
    await user.edit("`Uploading..`")
    await e.client.send_file(
        e.chat_id,
        file,
        caption="Here's your carbon, \n Carbonised by ᴀɴᴅᴇɴᴄᴇɴᴛᴏ",
        force_document=True,
...
async def carbon_api(e):
    if e.fwd_from:
        return
    user = await edit_or_reply(e, "`Processing....`")
    CARBON = "https://carbon.now.sh/?l={lang}&code={code}"
    textx = await e.get_reply_message()
    pcode = e.text
    if pcode[5:]:
...
@Andencento.on(admin_cmd(pattern="kar1(?: |$)(.*)", outgoing=True))
@Andencento.on(sudo_cmd(pattern="kar1(?: |$)(.*)", allow_sudo=True))
async def carbon_api(e):
    if e.fwd_from:
        return
    """ A Wrapper for carbon.now.sh """
    user = await edit_or_reply(e, "🔲🔲🔲🔲🔲")
    ...
    await user.edit("🔳🔳🔳🔳🔳")
    file = "./carbon.png"
    await user.edit("☣️Karbon1 Completed, Uploading Karbon☣️")
    await e.client.send_file(
        e.chat_id,
        file,
        force_document=True,
...
@Andencento.on(admin_cmd(pattern="kar2(?: |$)(.*)", outgoing=True))
...
async def carbon_api(e):
    ...
    await user.edit("🔘🔘🔘🔘🔘")
    file = "./carbon.png"
    await user.edit("☣️Karbon2 Completed, Uploading Karbon☣️")
    await e.client.send_file(
        e.chat_id,
        file,
...
@Andencento.on(admin_cmd(pattern="kar3(?: |$)(.*)", outgoing=True))
...
async def carbon_api(e):
    ...
    await user.edit("🔵🔵🔵🔵🔵")
    file = "./carbon.png"
    await user.edit("☣️Karbon3 Completed, Uploading Karbon⬆️")
    await e.client.send_file(
        e.chat_id,
        file,
...
@Andencento.on(admin_cmd(pattern="kar4(?: |$)(.*)", outgoing=True))
...
async def carbon_api(e):
    ...
    await user.edit("🌝🌝🌝🌝🌝")
    file = "./carbon.png"
    await user.edit("✅Karbon4 Completed, Uploading Karbon✅")
    await e.client.send_file(
        e.chat_id,
        file,
...
@Andencento.on(admin_cmd(pattern="rgbk2(?: |$)(.*)", outgoing=True))
...
async def carbon_api(e):
    ...
    await user.edit("⬛⬛⬛⬛⬛")
    file = "./carbon.png"
    await user.edit("✅RGB Karbon 2.0 Completed, Uploading Karbon✅")
    await e.client.send_file(
        e.chat_id,
        file,
...
@Andencento.on(admin_cmd(pattern="kargb(?: |$)(.*)", outgoing=True))
...
async def carbon_api(e):
    ...
    await user.edit("⬛⬛⬛⬛⬛")
    file = "./carbon.png"
    await user.edit("✅RGB Karbon Completed, Uploading Karbon✅")
    await e.client.send_file(
        e.chat_id,
        file,
        caption="Here's your karbonrgb",
